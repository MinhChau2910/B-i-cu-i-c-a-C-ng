...
public class MyBaggingModel extends MyKnowledgeModel {
    ...
    void buildBaggingModel(String cUsersViettelStoreDesktopdataexpiristrain) {
        
    }

    void predicClassLabel(String cUsersViettelStoreDesktopdataexpirisunlab, String cUsersViettelStoreDesktopdataexpirispredi) {
